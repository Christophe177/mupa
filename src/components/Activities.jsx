...
import { Calendar, Award, Briefcase, MapPin, Video, PenTool, Camera } from 'lucide-react';
    ...
    const activities = [
        {
            ...
            organization: 'EduBridge - Bridging Dreams',
            date: '2025',
            description: 'Strategic marketing with creative execution, including writing, documentation, visual production, and campaign coordination.',
        ...
        },
        {
            ...
            date: '2023',
            description: 'Professional shooting and editing of documentary films focusing on African narratives.',
            icon: <Camera size={20} />,
        },
        {
            id: 5,
            type: 'award',
            title: 'Short Documentary Film Winner',
            organization: 'Imitana Production & Kiruri MFN',
            date: '2022',
            description: 'Won the prestigious short documentary film award during the filmmaking boot camp.',
            icon: <Award size={20} />,
        },
        {
            id: 6,
        ...
        },
        {
            id: 7,
            type: 'experience',
            title: 'Audio Production Specialist & Presenter',
            organization: 'Isangano Radio 104.9FM',
            date: '2019',
            description: 'Radio presenting and audio production for jingles and visual graphic design for radio branding.',
            icon: <Briefcase size={20} />,
        },
    ];
